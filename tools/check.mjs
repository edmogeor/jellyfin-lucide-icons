...
if (!css.includes('#slides-container .play-button::before') || !css.includes('#slides-container.slideshow-paused .pause-button .material-icons') || !css.includes('.mute-button[aria-label="Unmute"]') || !css.includes('.seerrfin-discover-requests .material-icons') || !css.includes('.seerrfin-discover-card .cardText-secondary .material-icons')) {
