...
if (!css.includes('#slides-container .play-button::before') || !css.includes('#slides-container.slideshow-paused .pause-button .material-icons') || !css.includes('.seerrfin-discover-requests .material-icons')) {
